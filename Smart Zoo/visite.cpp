...
QSqlQueryModel * Visite::afficher()
{
    ...
    model->setHeaderData(0,Qt::Horizontal, QObject::tr("TicketID"));
    model->setHeaderData(1,Qt::Horizontal, QObject::tr("Ticket price"));
    model->setHeaderData(2,Qt::Horizontal, QObject::tr("Visitor ID"));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr("Visits number"));
    model->setHeaderData(4,Qt::Horizontal, QObject::tr("Visit date"));
    model->setHeaderData(5,Qt::Horizontal, QObject::tr("Subscription"));
